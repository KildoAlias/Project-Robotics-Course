...
def main():
    ...
    nav.start =[4.8, -0.5, 0.4]# demo01:[-0.2, -0.5, 0.4]# demo03:[4.8, -0.5, 0.4] # demo02: [4.8, -4.5, 0.4]
    nav.goal = [4.8, 0.5, 0.4]# demo01:[-0.2, 0.5, 0.4]# demo03:[4.8, 0.5, 0.4] # demo02: [4.8, -5.5, 0.4]
    nav.getPath()
    nav.printMAP()
    plt.show()
