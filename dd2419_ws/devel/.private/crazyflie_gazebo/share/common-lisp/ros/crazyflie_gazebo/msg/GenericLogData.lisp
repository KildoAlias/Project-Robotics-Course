...
(cl:defmethod cl:initialize-instance :after ((m <GenericLogData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GenericLogData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-msg:<GenericLogData> is deprecated: use crazyflie_gazebo-msg:GenericLogData instead.")))
...
(cl:defmethod values-val ((m <GenericLogData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:values-val is deprecated.  Use crazyflie_gazebo-msg:values instead.")
  (values m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GenericLogData>)))
  ...
  "crazyflie_gazebo/GenericLogData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GenericLogData)))
  "Returns string type for a message object of type 'GenericLogData"
  "crazyflie_gazebo/GenericLogData")
