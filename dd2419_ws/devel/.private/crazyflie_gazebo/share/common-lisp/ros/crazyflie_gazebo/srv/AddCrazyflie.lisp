...
(cl:defclass <AddCrazyflie-request> (roslisp-msg-protocol:ros-message)
  ((uri
   ...
   (log_blocks
    :reader log_blocks
    :initarg :log_blocks
    :type (cl:vector crazyflie_gazebo-msg:LogBlock)
   :initform (cl:make-array 0 :element-type 'crazyflie_gazebo-msg:LogBlock :initial-element (cl:make-instance 'crazyflie_gazebo-msg:LogBlock)))
   (use_ros_time
    :reader use_ros_time
   ...
   (enable_logging_packets
    ...
    :initform cl:nil)
   (enable_logging_pose
    :reader enable_logging_pose
    :initarg :enable_logging_pose
    :type cl:boolean
    :initform cl:nil)
   (enable_logging_setpoint_pose
    :reader enable_logging_setpoint_pose
    :initarg :enable_logging_setpoint_pose
    :type cl:boolean
    :initform cl:nil))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AddCrazyflie-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddCrazyflie-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<AddCrazyflie-request> is deprecated: use crazyflie_gazebo-srv:AddCrazyflie-request instead.")))

(cl:ensure-generic-function 'uri-val :lambda-list '(m))
(cl:defmethod uri-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:uri-val is deprecated.  Use crazyflie_gazebo-srv:uri instead.")
  (uri m))

(cl:ensure-generic-function 'tf_prefix-val :lambda-list '(m))
(cl:defmethod tf_prefix-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:tf_prefix-val is deprecated.  Use crazyflie_gazebo-srv:tf_prefix instead.")
  (tf_prefix m))

(cl:ensure-generic-function 'roll_trim-val :lambda-list '(m))
(cl:defmethod roll_trim-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:roll_trim-val is deprecated.  Use crazyflie_gazebo-srv:roll_trim instead.")
  (roll_trim m))

(cl:ensure-generic-function 'pitch_trim-val :lambda-list '(m))
(cl:defmethod pitch_trim-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:pitch_trim-val is deprecated.  Use crazyflie_gazebo-srv:pitch_trim instead.")
  (pitch_trim m))

(cl:ensure-generic-function 'enable_logging-val :lambda-list '(m))
(cl:defmethod enable_logging-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging instead.")
  (enable_logging m))

(cl:ensure-generic-function 'enable_parameters-val :lambda-list '(m))
(cl:defmethod enable_parameters-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_parameters-val is deprecated.  Use crazyflie_gazebo-srv:enable_parameters instead.")
  (enable_parameters m))

(cl:ensure-generic-function 'log_blocks-val :lambda-list '(m))
(cl:defmethod log_blocks-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:log_blocks-val is deprecated.  Use crazyflie_gazebo-srv:log_blocks instead.")
  (log_blocks m))

(cl:ensure-generic-function 'use_ros_time-val :lambda-list '(m))
(cl:defmethod use_ros_time-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:use_ros_time-val is deprecated.  Use crazyflie_gazebo-srv:use_ros_time instead.")
  (use_ros_time m))
...
(cl:defmethod enable_logging_imu-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_imu-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_imu instead.")
...
(cl:defmethod enable_logging_temperature-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_temperature-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_temperature instead.")
...
(cl:defmethod enable_logging_magnetic_field-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_magnetic_field-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_magnetic_field instead.")
...
(cl:defmethod enable_logging_pressure-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_pressure-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_pressure instead.")
...
(cl:defmethod enable_logging_battery-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_battery-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_battery instead.")
...
(cl:defmethod enable_logging_packets-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_packets-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_packets instead.")
  (enable_logging_packets m))

(cl:ensure-generic-function 'enable_logging_pose-val :lambda-list '(m))
(cl:defmethod enable_logging_pose-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_pose-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_pose instead.")
  (enable_logging_pose m))

(cl:ensure-generic-function 'enable_logging_setpoint_pose-val :lambda-list '(m))
(cl:defmethod enable_logging_setpoint_pose-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:enable_logging_setpoint_pose-val is deprecated.  Use crazyflie_gazebo-srv:enable_logging_setpoint_pose instead.")
  (enable_logging_setpoint_pose m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AddCrazyflie-request>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'enable_logging_pose) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'enable_logging_setpoint_pose) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AddCrazyflie-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'log_blocks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'crazyflie_gazebo-msg:LogBlock))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    ...
    (cl:setf (cl:slot-value msg 'enable_logging_pose) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'enable_logging_setpoint_pose) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddCrazyflie-request>)))
  ...
  "crazyflie_gazebo/AddCrazyflieRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddCrazyflie-request)))
  "Returns string type for a service object of type 'AddCrazyflie-request"
  "crazyflie_gazebo/AddCrazyflieRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AddCrazyflie-request>)))
  ...
  "5b766bccbd53020b32ac296756de42f0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AddCrazyflie-request)))
  "Returns md5sum for a message object of type 'AddCrazyflie-request"
  "5b766bccbd53020b32ac296756de42f0")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <AddCrazyflie-request>))
  ...
  (cl:list 'AddCrazyflie-request
    ...
    (cl:cons ':enable_logging_pose (enable_logging_pose msg))
    (cl:cons ':enable_logging_setpoint_pose (enable_logging_setpoint_pose msg))
))
...
(cl:defmethod cl:initialize-instance :after ((m <AddCrazyflie-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddCrazyflie-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<AddCrazyflie-response> is deprecated: use crazyflie_gazebo-srv:AddCrazyflie-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddCrazyflie-response>)))
  ...
  "crazyflie_gazebo/AddCrazyflieResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddCrazyflie-response)))
  "Returns string type for a service object of type 'AddCrazyflie-response"
  "crazyflie_gazebo/AddCrazyflieResponse")
