...
class AddCrazyflieRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.enable_logging_setpoint_pose = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('enable_logging_setpoint_pose')) {
        this.enable_logging_setpoint_pose = initObj.enable_logging_setpoint_pose
      }
      else {
        this.enable_logging_setpoint_pose = false;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [enable_logging_setpoint_pose]
    bufferOffset = _serializer.bool(obj.enable_logging_setpoint_pose, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [enable_logging_setpoint_pose]
    data.enable_logging_setpoint_pose = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'crazyflie_gazebo/AddCrazyflieRequest';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.enable_logging_setpoint_pose !== undefined) {
      resolved.enable_logging_setpoint_pose = msg.enable_logging_setpoint_pose;
    }
    else {
      resolved.enable_logging_setpoint_pose = false
    }
...
module.exports = {
  ...
  md5sum() { return '5b766bccbd53020b32ac296756de42f0'; },
  datatype() { return 'crazyflie_gazebo/AddCrazyflie'; }
};
