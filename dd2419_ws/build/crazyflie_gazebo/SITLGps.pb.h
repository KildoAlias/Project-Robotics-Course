...
class SITLGps : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gz_gps_msgs.SITLGps) */ {
 public:
  SITLGps();
  virtual ~SITLGps();
  ...
  // @@protoc_insertion_point(class_scope:gz_gps_msgs.SITLGps)
 private:
