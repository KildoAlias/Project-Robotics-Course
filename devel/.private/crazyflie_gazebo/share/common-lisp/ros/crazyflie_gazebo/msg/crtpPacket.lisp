...
(cl:defmethod cl:initialize-instance :after ((m <crtpPacket>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'crtpPacket)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-msg:<crtpPacket> is deprecated: use crazyflie_gazebo-msg:crtpPacket instead.")))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <crtpPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:size-val is deprecated.  Use crazyflie_gazebo-msg:size instead.")
  (size m))
...
(cl:defmethod data-val ((m <crtpPacket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:data-val is deprecated.  Use crazyflie_gazebo-msg:data instead.")
  (data m))
