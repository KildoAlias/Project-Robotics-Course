...
(cl:defmethod cl:initialize-instance :after ((m <LogBlock>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LogBlock)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-msg:<LogBlock> is deprecated: use crazyflie_gazebo-msg:LogBlock instead.")))

(cl:ensure-generic-function 'topic_name-val :lambda-list '(m))
(cl:defmethod topic_name-val ((m <LogBlock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:topic_name-val is deprecated.  Use crazyflie_gazebo-msg:topic_name instead.")
  (topic_name m))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <LogBlock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:frequency-val is deprecated.  Use crazyflie_gazebo-msg:frequency instead.")
  (frequency m))

(cl:ensure-generic-function 'variables-val :lambda-list '(m))
(cl:defmethod variables-val ((m <LogBlock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:variables-val is deprecated.  Use crazyflie_gazebo-msg:variables instead.")
  (variables m))
