...
(cl:defmethod cl:initialize-instance :after ((m <WindSpeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WindSpeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-msg:<WindSpeed> is deprecated: use crazyflie_gazebo-msg:WindSpeed instead.")))
...
(cl:defmethod velocity-val ((m <WindSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-msg:velocity-val is deprecated.  Use crazyflie_gazebo-msg:velocity instead.")
  (velocity m))
