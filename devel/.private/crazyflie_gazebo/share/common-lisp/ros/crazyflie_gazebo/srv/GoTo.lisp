...
(cl:defmethod cl:initialize-instance :after ((m <GoTo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoTo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<GoTo-request> is deprecated: use crazyflie_gazebo-srv:GoTo-request instead.")))
...
(cl:defmethod goal-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:goal-val is deprecated.  Use crazyflie_gazebo-srv:goal instead.")
  (goal m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:yaw-val is deprecated.  Use crazyflie_gazebo-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:duration-val is deprecated.  Use crazyflie_gazebo-srv:duration instead.")
  (duration m))
...
(cl:defmethod cl:initialize-instance :after ((m <GoTo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoTo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<GoTo-response> is deprecated: use crazyflie_gazebo-srv:GoTo-response instead.")))
