...
(cl:defmethod cl:initialize-instance :after ((m <Land-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Land-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<Land-request> is deprecated: use crazyflie_gazebo-srv:Land-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Land-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Land-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<Land-response> is deprecated: use crazyflie_gazebo-srv:Land-response instead.")))
