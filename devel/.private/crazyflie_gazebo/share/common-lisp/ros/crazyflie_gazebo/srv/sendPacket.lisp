...
(cl:defclass <sendPacket-request> (roslisp-msg-protocol:ros-message)
  ((packet
    :reader packet
    :initarg :packet
    :type crazyflie_gazebo-msg:crtpPacket
    :initform (cl:make-instance 'crazyflie_gazebo-msg:crtpPacket)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <sendPacket-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sendPacket-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<sendPacket-request> is deprecated: use crazyflie_gazebo-srv:sendPacket-request instead.")))

(cl:ensure-generic-function 'packet-val :lambda-list '(m))
(cl:defmethod packet-val ((m <sendPacket-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:packet-val is deprecated.  Use crazyflie_gazebo-srv:packet instead.")
  (packet m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sendPacket-request>)))
  ...
  "crazyflie_gazebo/sendPacketRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sendPacket-request)))
  "Returns string type for a service object of type 'sendPacket-request"
  "crazyflie_gazebo/sendPacketRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<sendPacket-request>)))
  ...
  (cl:format cl:nil "crazyflie_gazebo/crtpPacket packet~%~%================================================================================~%MSG: crazyflie_gazebo/crtpPacket~%uint8 size~%uint8 header~%uint8[30] data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'sendPacket-request)))
  "Returns full string definition for message of type 'sendPacket-request"
  (cl:format cl:nil "crazyflie_gazebo/crtpPacket packet~%~%================================================================================~%MSG: crazyflie_gazebo/crtpPacket~%uint8 size~%uint8 header~%uint8[30] data~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <sendPacket-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sendPacket-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<sendPacket-response> is deprecated: use crazyflie_gazebo-srv:sendPacket-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sendPacket-response>)))
  ...
  "crazyflie_gazebo/sendPacketResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sendPacket-response)))
  "Returns string type for a service object of type 'sendPacket-response"
  "crazyflie_gazebo/sendPacketResponse")
