...
(cl:defmethod cl:initialize-instance :after ((m <StartTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<StartTrajectory-request> is deprecated: use crazyflie_gazebo-srv:StartTrajectory-request instead.")))

(cl:ensure-generic-function 'groupMask-val :lambda-list '(m))
(cl:defmethod groupMask-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:groupMask-val is deprecated.  Use crazyflie_gazebo-srv:groupMask instead.")
  (groupMask m))
...
(cl:defmethod timescale-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:timescale-val is deprecated.  Use crazyflie_gazebo-srv:timescale instead.")
  (timescale m))

(cl:ensure-generic-function 'reversed-val :lambda-list '(m))
(cl:defmethod reversed-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:reversed-val is deprecated.  Use crazyflie_gazebo-srv:reversed instead.")
  (reversed m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_gazebo-srv:relative-val is deprecated.  Use crazyflie_gazebo-srv:relative instead.")
  (relative m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartTrajectory-request>)))
  ...
  "crazyflie_gazebo/StartTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory-request)))
  "Returns string type for a service object of type 'StartTrajectory-request"
  "crazyflie_gazebo/StartTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <StartTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_gazebo-srv:<StartTrajectory-response> is deprecated: use crazyflie_gazebo-srv:StartTrajectory-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartTrajectory-response>)))
  ...
  "crazyflie_gazebo/StartTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory-response)))
  "Returns string type for a service object of type 'StartTrajectory-response"
  "crazyflie_gazebo/StartTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory)))
  ...
  "crazyflie_gazebo/StartTrajectory")