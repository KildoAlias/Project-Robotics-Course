// Generated by gencpp from file crazyflie_gazebo/AddCrazyflieRequest.msg
// DO NOT EDIT!


#ifndef CRAZYFLIE_GAZEBO_MESSAGE_ADDCRAZYFLIEREQUEST_H
#define CRAZYFLIE_GAZEBO_MESSAGE_ADDCRAZYFLIEREQUEST_H
...
struct AddCrazyflieRequest_
{
  ...
  AddCrazyflieRequest_()
    ...
    , enable_logging_setpoint_pose(false)  {
    }
  ...
  _enable_parameters_type enable_parameters;
   ...
   typedef std::vector< ::crazyflie_gazebo::LogBlock_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::crazyflie_gazebo::LogBlock_<ContainerAllocator> >::other >  _log_blocks_type;
  ...
  _enable_logging_pose_type enable_logging_pose;
   ...
   typedef uint8_t _enable_logging_setpoint_pose_type;
  _enable_logging_setpoint_pose_type enable_logging_setpoint_pose;





  typedef boost::shared_ptr< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> const> ConstPtr;

}; // struct AddCrazyflieRequest_

typedef ::crazyflie_gazebo::AddCrazyflieRequest_<std::allocator<void> > AddCrazyflieRequest;

typedef boost::shared_ptr< ::crazyflie_gazebo::AddCrazyflieRequest > AddCrazyflieRequestPtr;
typedef boost::shared_ptr< ::crazyflie_gazebo::AddCrazyflieRequest const> AddCrazyflieRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5b766bccbd53020bULL;
  static const uint64_t static_value2 = 0x32ac296756de42f0ULL;
};

template<class ContainerAllocator>
struct DataType< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string uri\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.enable_logging_setpoint_pose);
    }
...
template<class ContainerAllocator>
struct Printer< ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::crazyflie_gazebo::AddCrazyflieRequest_<ContainerAllocator>& v)
  {
    s << indent << "uri: ";
    ...
    for (size_t i = 0; i < v.log_blocks.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::crazyflie_gazebo::LogBlock_<ContainerAllocator> >::stream(s, indent + "    ", v.log_blocks[i]);
    }
    ...
    s << indent << "enable_logging_setpoint_pose: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.enable_logging_setpoint_pose);
  }
};
...
#endif // CRAZYFLIE_GAZEBO_MESSAGE_ADDCRAZYFLIEREQUEST_H
