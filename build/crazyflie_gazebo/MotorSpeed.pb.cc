...
// @@protoc_insertion_point(message_clear_start:gz_mav_msgs.MotorSpeed)
  motor_speed_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
// @@protoc_insertion_point(message_byte_size_start:gz_mav_msgs.MotorSpeed)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:gz_mav_msgs.MotorSpeed)
  ...
  const MotorSpeed* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const MotorSpeed>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:gz_mav_msgs.MotorSpeed)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:gz_mav_msgs.MotorSpeed)
    MergeFrom(*source);
  }
}

void MotorSpeed::MergeFrom(const MotorSpeed& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:gz_mav_msgs.MotorSpeed)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:gz_mav_msgs.MotorSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:gz_mav_msgs.MotorSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MotorSpeed::clear_motor_speed() {
 ...
 float MotorSpeed::motor_speed(int index) const {
  // @@protoc_insertion_point(field_get:gz_mav_msgs.MotorSpeed.motor_speed)
  return motor_speed_.Get(index);
}
 void MotorSpeed::set_motor_speed(int index, float value) {
  motor_speed_.Set(index, value);
  // @@protoc_insertion_point(field_set:gz_mav_msgs.MotorSpeed.motor_speed)
}
 void MotorSpeed::add_motor_speed(float value) {
  motor_speed_.Add(value);
  // @@protoc_insertion_point(field_add:gz_mav_msgs.MotorSpeed.motor_speed)
}
 const ::google::protobuf::RepeatedField< float >&
MotorSpeed::motor_speed() const {
  // @@protoc_insertion_point(field_list:gz_mav_msgs.MotorSpeed.motor_speed)
  return motor_speed_;
}
 ::google::protobuf::RepeatedField< float >*
MotorSpeed::mutable_motor_speed() {
  // @@protoc_insertion_point(field_mutable_list:gz_mav_msgs.MotorSpeed.motor_speed)
  return &motor_speed_;
}
